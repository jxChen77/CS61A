...
class VendingMachine:
    ...
    def vend(self):
        if self.amount == 0:
            ...
            if self.balance < self.price:
                ...
                re = self.balance - self.price
                self.balance = 0
                self.amount-=1
                return f"Here is your {self.goods} and ${re} change."
            else:
                self.balance = 0
                self.amount-=1
    ...
    def restock(self, num):
        self.amount+=num
        return f"Current {self.goods} stock: {self.amount}"
...
class Player:
    ...
    def debate(self, other):
        "*** YOUR CODE HERE ***"
        gap = max(0.1, self.popularity / (self.popularity + other.popularity))
        temp = random()
...
class AggressivePlayer(Player):
    ...
    def choose(self, other):
        ...
        if self.popularity <= other.popularity:
            return self.debate
        else: return Player.choose(self, other)
...
class VirFib():
    ...
    def next(self):
        ...
        return VirFib(next_value, self.value )
