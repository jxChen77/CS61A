...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        argsList=[]
        if temp:
            argsList.append(temp.first)
        while temp and temp.rest is not nil:
            argsList.append(temp.rest.first)
            temp = temp.rest
        ...
        "*** YOUR CODE HERE ***"
        print("DEBUG:", procedure.formals, procedure.body)
...
def eval_all(expressions, env):
    ...
    if len(expressions) == 1:
        ...
        # print("DEBUG:", len(expressions.rest))
